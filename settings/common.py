"""Django settings for dj-init-travis-test project.
...
APPS_DIR = ROOT_DIR.path("dj_init_travis_test")
...
INSTALLED_APPS = (
    ...
    "dj_init_travis_test.base",
    "dj_init_travis_test.users",
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    "DEFAULT_PAGINATION_CLASS": "dj_init_travis_test.base.api.pagination.PageNumberPagination",
    "PAGE_SIZE": 30,

    # Default renderer classes for Rest framework
    "DEFAULT_RENDERER_CLASSES": [
        "dj_init_travis_test.base.renderers.DjInitTravisTestApiRenderer",
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": (
        ...
        "dj_init_travis_test.users.auth.backends.UserTokenAuthentication",
        # Mainly used for api debug.
        "rest_framework.authentication.SessionAuthentication",
    ),
    "DEFAULT_SCHEMA_CLASS": 'rest_framework.schemas.coreapi.AutoSchema',
    "EXCEPTION_HANDLER": "dj_init_travis_test.base.exceptions.exception_handler",
}
...
SITE_NAME = env("SITE_NAME", default="dj-init-travis-test")
...
FRONTEND_SITE_NAME = env("FRONTEND_SITE_NAME", default="dj-init-travis-test")
...
# URL CONFIGURATION
# ------------------------------------------------------------------------------
ROOT_URLCONF = "dj_init_travis_test.urls"
...
DEFAULT_FROM_EMAIL = env(
    "DEFAULT_FROM_EMAIL", default="dj-init-travis-test <support@dj_init_travis_test.com>"
)
EMAIL_SUBJECT_PREFIX = env("EMAIL_SUBJECT_PREFIX", default="[dj-init-travis-test] ")
...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres://localhost/dj_init_travis_test")
}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                "dj_init_travis_test.base.context_processors.site_settings",
...
CSRF_FAILURE_VIEW = "dj_init_travis_test.base.views.csrf_failure"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "dj_init_travis_test": {"handlers": ["console"], "level": "INFO", "propagate": False},
...
def get_release():
    import dj_init_travis_test
    import os
    import raven

    release = dj_init_travis_test.__version__
    try:
