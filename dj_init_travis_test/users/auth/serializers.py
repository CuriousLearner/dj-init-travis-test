...
from dj_init_travis_test.users import services as user_services
from dj_init_travis_test.users.models import UserManager
from dj_init_travis_test.users.serializers import UserSerializer
