...
In your terminal, type or copy-paste the following:
    ...
    git clone git@github.com:CuriousLearner/dj-init-travis-test-web.git; cd dj-init-travis-test-web; fab init
...
## How to release dj-init-travis-test
...
[contributing]: http://github.com/CuriousLearner/dj-init-travis-test-web/tree/master/CONTRIBUTING.md
