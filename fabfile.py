...
#  Settings
# ==========================================================================
env.project_name = "dj_init_travis_test"
...
def dev():
    ...
    env.remote = "origin"
    env.branch = "master"
    env.hosts = ["dev.dj_init_travis_test.com"]
    env.dotenv_path = "/home/ubuntu/dev/dj_init_travis_test/.env"
...
def qa():
    ...
    env.remote = "origin"
    env.branch = "qa"
    env.hosts = ["qa.dj_init_travis_test.com"]
    env.dotenv_path = "/home/ubuntu/qa/dj_init_travis_test/.env"
    env.config_setter = fab.run
...
def prod():
    ...
    env.remote = "origin"
    env.branch = "prod"
    env.hosts = ["prod.dj_init_travis_test.com"]
    env.dotenv_path = "/home/ubuntu/prod/dj_init_travis_test/.env"
    env.config_setter = fab.run
